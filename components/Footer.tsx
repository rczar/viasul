...
const SocialIcon: React.FC<{ href: string; children: React.ReactNode }> = ({ href, children }) => (
    <a href={href} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors">{children}</a>
);

const Footer: React.FC = () => {
    return (
        <footer className="bg-viasul-wine-dark text-white py-10">
            <div className="container mx-auto px-6 text-center">
                <p className="font-semibold mb-2">© 2025 Viasul Corretora de Seguros — Protegendo seus sonhos com confiança.</p>
                <p className="text-sm text-gray-400 mb-4">Corretora autorizada SUSEP</p>
